        ...
        <div className="row project__pcontent">
          ...
          <div className="col-1-of-2 project__text-box">
            <p>
              ...
              Distinctio voluptatibus minus vitae, corporis veniam, eligendi
              officiis natus quisquam qui alias et necessitatibus adipisci
              maxime non? Accusamus cum ducimus rerum fugit.
            </p>
          </div>
        </div>
        <div className="row project__pcontent">
